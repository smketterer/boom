...
for (var i=0; i<argument4; i++) {
  ...
  if collision_object != noone and collision_object != self.id and collision_object.object_index != objBlock and (collision_object.z == argument2 or abs(layer_get_depth(collision_object.layer) - round(z)) < 32) {
